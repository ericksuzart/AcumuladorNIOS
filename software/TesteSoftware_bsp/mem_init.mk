...
# Memory: MemoriaDeDados
MEM_0 := DadosDaMemoria
$(MEM_0)_NAME := MemoriaDeDados
...
$(MEM_0)_HIERARCHICAL_PATH := MemoriaDeDados
$(MEM_0)_WIDTH := 32
$(MEM_0)_HEX_DATA_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: MemoriaDeDados
MemoriaDeDados: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: MemoriaDePrograma
MEM_1 := SistemaEmbarcadoAcumulador_MemoriaDePrograma
$(MEM_1)_NAME := MemoriaDePrograma
...
$(MEM_1)_HIERARCHICAL_PATH := MemoriaDePrograma
$(MEM_1)_WIDTH := 32
$(MEM_1)_HEX_DATA_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: MemoriaDePrograma
MemoriaDePrograma: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
